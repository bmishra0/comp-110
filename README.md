...
5. Open the _View_ menu and select _Command Palette_, the shortcut for this menu is:
   ...
   - Mac: `Command+Shift+P`
6. Begin typing in: `Git: Push` and press `Enter` once it is the first option.
   ...
   - If you want to see your backed up work on Github, open GitHub in your web browser and navigate to your repository. You should see your work in the code area and your commit message as the latest commit just above the files.
...
4. Press enter with `upstream/main` as the first option.
...
6. If prompted to that "Configuration file(s) changed" always select "Rebuild" to rebuild your workspace with the latest features needed for the course. It take about a minute to update.# comp-110
